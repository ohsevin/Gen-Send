<div id="gensend">
    <div id="headlines">
        <h3>About Gen&amp;Send's Password Generator</h3>
        <div class="copy">
            <p>
                This tool is a PHP application to generate and send passwords over the web. Created by <a href="http://maffyoo.co.uk">Matthew Brunt</a>.
            </p>
            <p>
                No passwords are stored when generated <strong>unless you send them securely to the <a href="send/">Secure-send tool.</a> This is not done unless you click the "Transfer to secure send tool..." button and complete the form.</strong>
            </p>
            <p>
