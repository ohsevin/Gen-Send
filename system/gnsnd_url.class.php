...
class GNSND_Url {
    ...
    function __construct($url_array, $o_url_array, $extra_query_string)
    {
        $this->_url_parts = $url_array;
        $this->_o_url_parts = $o_url_array;
    ...
    public function osegment($segment_part)
    {
         return isset($this->_o_url_parts[$segment_part-1]) ? $this->_o_url_parts[$segment_part-1] : false;
    }
